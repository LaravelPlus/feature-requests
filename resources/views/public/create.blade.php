    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-6">
                <div class="flex items-start">
                    <svg class="w-6 h-6 text-gray-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-sm font-semibold text-green-900 mb-2">How Voting Works:</h3>
                        <ul class="text-sm text-green-800 space-y-1">
                            <li>• <strong>Upvote:</strong> Show support for this feature</li>
                            <li>• <strong>Downvote:</strong> Express concerns or disagreement</li>
                            <li>• <strong>Net Score:</strong> Determines feature priority naturally</li>
                            <li>• <strong>One Vote:</strong> Each user can vote once per feature</li>
                        </ul>
                    </div>
                </div>
            </div>
